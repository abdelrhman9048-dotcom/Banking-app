...
const Register = () => {
  const { register: registerAdmin } = useContext(AdminAuthContext);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-[#0a0f1f] via-[#101a3a] to-[#1a237e] p-6">
      <motion.div
      ...
      >
        ...
        >
          <div className="w-20 h-20 mx-auto bg-linear-to-br from-yellow-400 to-purple-600 rounded-full flex items-center justify-center shadow-lg mb-4">
            <UserPlus size={36} />
          </div>
          ...
          <p className="text-gray-300 mt-2">
            ابدأ تجربتك البنكية الذكية الآن ✨
          </p>
        </motion.div>
